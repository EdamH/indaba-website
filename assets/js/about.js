...
function LandingPageScrollTrigger() {
    ...
    LandingPageScrollTrigger
        .to('#ImgWrapper #img7', { duration: 2,transform: 'translateZ(4500px)', }, 0)
        .to('#ImgWrapper #img6', { duration: 2,transform: 'translateZ(3700px)', }, 0)
        .to('#ImgWrapper #img5', { duration: 2,transform: 'translateZ(3100px)', }, 0)
        .to('#ImgWrapper #img4', { duration: 2,transform: 'translateZ(2800px)', }, 0)
        .to('#ImgWrapper #img3', { duration: 2,transform: 'translateZ(2600px)', }, 0)
        .to('#ImgWrapper #img2', { duration: 2,transform: 'translateZ(2400px)', }, 0)
        .to('#ImgWrapper #img1', { duration: 2,transform: 'translateZ(2200px)', }, 0)
